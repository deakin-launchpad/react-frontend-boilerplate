...
export const AppRoutes = (props) => {
  ...
  return (
    <Switch>
      ...
      <Route exact path='/login' render={() => ((redirectToLogin ? <Login  {...props} /> : <Redirect to={{ pathname: landingPage }} {...props} />))} />
      <Route exact path='/register' render={() => ((redirectToLogin ? <Register {...props} /> : <Redirect to={{ pathname: landingPage }} {...props} />))} />
      <Layout>
